...
برای دسترسی به پی دی افِ لغات ، از طریق لینک یکبار مصرفِ زیر،عضو کانال ما شوید.

{telegram_link}

و همچنین برای دسترسی به دوره در اینستاگرام، با آیدی‌ پیجی که بالا برای ما ارسال کردید، به پیج زیر ریکوئست دهید و تا زمان قبول شدن ریکوئست منتظر بمانید.
از صبر و بردباری شما متشکریم❤️🙏

آیدی اینستاگرام: {instagram_link}
'''
